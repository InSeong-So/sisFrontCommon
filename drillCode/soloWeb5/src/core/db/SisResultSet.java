...
public class SisResultSet
{
    ...
    public static SisResultSet make(ResultSet rset) throws SQLException
    {
        return new SisResultSet(rset);
    }
    ...
    public SisResultSet(ResultSet rset, boolean bCloseAfterParse) throws SQLException
    {
        parse(rset, bCloseAfterParse);
    }
    
    public SisResultSet(ResultSet rset) throws SQLException
    {
        parse(rset, true);
    }
